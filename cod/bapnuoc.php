...
<body background="" style="background-color: brown;">
    <div class="main_body">
        ...
        <div class="Page_Content">
            <div>
                <div>
                    <img src="https://api-website.cinestar.com.vn/media/MageINIC/bannerslider/bap-nuoc-onl.jpg" alt="">
                </div>
                <div class="container_dropdown">
                    <h1 style="text-transform: uppercase;text-align: center;color: white;">chọn rạp gần bạn</h1>
                    <div class="dropdown">
                        <select >
                    ...
                    <div class="product-card">
                        <div style="display: flex;">
                            <div class="product-image">
                                <img src="../image/bg_giaitri.jpeg" alt="Bia Heineken 330ml">
                            </div>
                            <div class="product-info">
                                <h2 class="product-title">BIA HEINEKEN 330ML</h2>
                                <p class="product-description">Bia Heineken 330ml</p>
                                <p class="product-price">49,000VND</p>
                ...
                <div class="yumi">
                    ...
                    <div class="product-card">
                        <div style="display: flex;">
                            <div class="product-image">
                                <img src="../image/wibu.jpg" alt="Bia Heineken 330ml">
                            </div>
                            <div class="product-info">
                                <h2 class="product-title">BE BAY</h2>
                                <p class="product-description">be bay hsr</p>
                                <p class="product-price">49,000VND</p>
                                <div class="product-quantity">
                                    <button class="quantity-btn">-</button>
                                    <span class="quantity">0</span>
                ...
                <div class="yumi" style="margin-bottom: 50px;">
                    <p>Nuoc uong</p>
                    <div class="product-card">
                        <div style="display: flex;">
                            <div class="product-image">
